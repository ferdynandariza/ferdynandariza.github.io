...
module.exports = plugin(function ({ addBase, addUtilities, theme }) {
  addBase({
    ...
    '.dark': {
      '--color-custom-50': '#030712',
      '--color-custom-100': '#111827',
      '--color-custom-200': '#1f2937',
      '--color-custom-300': '#374151',
      '--color-custom-400': '#4b5563',
      '--color-custom-500': '#6b7280',
      '--color-custom-600': '#9ca3af',
      '--color-custom-700': '#d1d5db',
      '--color-custom-800': '#e5e7eb',
      '--color-custom-900': '#f3f4f6',
